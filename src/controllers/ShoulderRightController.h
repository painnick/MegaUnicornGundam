...
class ShoulderRightController : public DefaultServoController {
public:
    ...
    explicit ShoulderRightController(uint8_t aPCA9685I2CAddress, const String &nickName) : DefaultServoController(
